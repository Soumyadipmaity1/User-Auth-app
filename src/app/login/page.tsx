...
toast.error(error.message)
  ...
  return (
    ...
    <div className="p-1 flex items-center w-72">
      <FaEnvelope className="text-orange-500 mr-2 text-2xl" />
      <input
        type="email"
        id="email"
        value={user.email}
        ...
        className="p-2 border rounded-lg text-black mb-4 focus:outline-none focus:border-gray-600 w-full"
      />
    </div>
    <div className="p-1 flex items-center w-72">
      <FaLock className="text-orange-500 mr-2 text-2xl" />
      <input
        type="password"
        id="password"
        value={user.password}
